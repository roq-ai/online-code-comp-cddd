  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Online Code Compiler: Seamlessly compile your code in multiple languages like C, C++, Java, Python, Javascript, and more. Secure authentication and user-friendly interface designed for developers, by developers."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1461749280684-dccba630e2f6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjb2Rpbmd8ZW58MHx8fHwxNjk1MzUxOTQwfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@ilyapavlov?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Ilya Pavlov`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Online Code Compiler: Seamlessly compile your code in multiple languages like C, C++, Java, Python, Javascript, and more. Secure authentication and user-friendly interface designed for developers, by developers.`}
            </Text>
            <Box
